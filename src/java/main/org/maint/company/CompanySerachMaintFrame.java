 ...
 *
 */
public class CompanySerachMaintFrame extends AbstractMdiModelessWindow {

    private static final long serialVersionUID = -5968216660329452488L;

    private CompanySearchMaintComp comp;
     ...
     */
    public CompanySerachMaintFrame() throws HeadlessException {
     ...
     * @throws HeadlessException
     */
    public CompanySerachMaintFrame(Dimension size, Point pos, String winTitle)
            throws HeadlessException {
    ...
    public JPanel createContentLayout() {
        ...
        this.comp = new CompanySearchMaintComp(false);
