 ...
 *
 */
public class ClientSearchMaintComp extends
    ...
    public static final String ACTION_COMMAND_COPY_CONTACT_INFO = "COPY CONTACT INFO TO BILLING";
     ...
     */
    public ClientSearchMaintComp(boolean readOnly) {
        super(readOnly);
        return;
    }
    ...
    protected void initFields() {
        ...
        this.compBo = new CompanyBO();
        this.stateList = this.coBo.getUsStates();
        this.companyClientList = this.compBo
    ...
    private JPanel buildSection1() {
        ...
        sect1.setLayout(new MigLayout("", "[][grow][][grow][][grow][][grow]",
                "[][][]"));

        // Create Section Title
        JLabel lbl = new JLabel("Client Search Criteria");
        ...
        // Create First row
        sect1.add(FormUtil.createHeaderLabel("Client Id: "), "right, top");
        sect1.add(this.srchClientIdField, "width 90, left");

        sect1.add(FormUtil.createHeaderLabel("First Name: "), "right, top");
        sect1.add(this.srchFirstNameField, "width 120, left");

        sect1.add(FormUtil.createHeaderLabel("Last Name: "), "right, top");
        sect1.add(this.srchLastNameField, "width 120, left");

        sect1.add(FormUtil.createHeaderLabel("Company: "), "right, top");
        this.srchCompanyField = FormUtil.createCompanyInfoDDB(
                this.companyClientList, null, 70);
        sect1.add(this.srchCompanyField, "growx, left, wrap");

        // Create second row
        sect1.add(FormUtil.createHeaderLabel("State: "), "right, top");
        ...
        sect1.add(FormUtil.createHeaderLabel("City: "), "right, top");
        sect1.add(this.srchCityField, "growx, left");

        sect1.add(FormUtil.createHeaderLabel("Zip: "), "right, top");
        sect1.add(this.srchZipField, "growx, left");

        sect1.add(FormUtil.createHeaderLabel("Phone: "), "right, top");
    ...
    private JPanel buildSection3() {
        ...
        if (!this.readlOnly) {
            this.cbxDupBilling
                    .setActionCommand(ClientSearchMaintComp.ACTION_COMMAND_COPY_CONTACT_INFO);
    ...
    public void doSearch() {
        ...
        ClientSearchCriteriaBean userInput = new ClientSearchCriteriaBean();
        String strVal = null;
    ...
    public void doDelete() {
        try {
            this.bo.deleteClient(this.selectedClient.getClientId());
    ...
    protected class RetrieveDataThread implements Runnable {
        private ClientSearchMaintComp parent;
        private ClientSearchCriteriaBean criteria;

        protected RetrieveDataThread(ClientSearchMaintComp parent,
                ClientSearchCriteriaBean data) {
            this.parent = parent;
            this.criteria = data;
        }
    ...
    protected class RetrieveZipDataThread implements Runnable {
        ...
        protected RetrieveZipDataThread(ClientSearchMaintComp parent,
    ...
    public void saveChanges() {
        ...
        try {
            ...
            // this.lblMsg.setText("Update was successful!");
            FormUtil.showStatusMessage(this.lblMsg, "Update was successful!",
                    false);
        } catch (Exception e) {
            FormUtil.showStatusMessage(this.lblMsg, "Update of client failed: "
                    + e.getMessage(), true);
            // this.lblMsg.setText("Update of client failed: " +
            // e.getMessage());
        }
        return;
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getActionCommand().equals(
                ClientSearchMaintComp.ACTION_COMMAND_COPY_CONTACT_INFO)) {
